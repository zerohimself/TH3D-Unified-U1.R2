...
#if ENABLED(FIX_MOUNTED_PROBE) && (Z_MIN_ENDSTOP_INVERTING == false)
  #error "Nice try...this firmware is designed for the Genuine EZABL kit. Please purchase one from TH3DStudio.com. The Creality clone is NOT supported."
#endif
#if ENABLED(FIX_MOUNTED_PROBE) && (Z_MIN_PROBE_ENDSTOP_INVERTING == false)
  #error "Nice try...this firmware is designed for the Genuine EZABL kit. Please purchase one from TH3DStudio.com. The Creality clone is NOT supported."
#endif
