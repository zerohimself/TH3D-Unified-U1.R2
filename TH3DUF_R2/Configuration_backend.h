...
#if ENABLED(EZABL_ENABLE) && (Z_MIN_ENDSTOP_INVERTING == false)
  #error "This firmware is designed for the Genuine EZABL kit. Please purchase one from TH3DStudio.com. The Creality knock-off is NOT supported."
#endif
#if ENABLED(EZABL_ENABLE) && (Z_MIN_PROBE_ENDSTOP_INVERTING == false)
  #error "This firmware is designed for the Genuine EZABL kit. Please purchase one from TH3DStudio.com. The Creality knock-off is NOT supported."
#endif
#if ENABLED(EZABL_ENABLE)
